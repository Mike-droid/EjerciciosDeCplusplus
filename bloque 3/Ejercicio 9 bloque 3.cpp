...
int main(){ int numero, unidades, decenas, centenas, millar;
	cout<<"Digite un numero para convertirlo en numero romano: ";
	cin>>numero;
	//numero = 2152 -> 2000+100+50+2
	
	//Dividimos el número entre 10 para que nos deje el residuo
	//que es el que nos interesa en este caso en particular
